 ...
 * @author Lenovo
 */
public class SprintMeetingController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        List<Meeting> lus = ser.selectAllSprint();
        aff.addAll(lus);
    ...
    @FXML
    private void openSprint(ActionEvent event) throws SQLException {
    ...
    @FXML
    private void deleteAllSprint(ActionEvent event) {
    ...
    @FXML
    private void deleteSprintMeeting(ActionEvent event) {
    ...
    @FXML
    private void pdfSprint(ActionEvent event) throws SQLException, IOException, FileNotFoundException, DocumentException {
        SprintMeetingPDF pdf = new SprintMeetingPDF();

        try {
            pdf.listMeetings();
        } catch (DocumentException ex) {
            Logger.getLogger(SprintMeetingController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    @FXML
    private void statSprint(ActionEvent event) {
    }

    @FXML
    private void EditSprint(ActionEvent event) throws IOException, SQLException {
